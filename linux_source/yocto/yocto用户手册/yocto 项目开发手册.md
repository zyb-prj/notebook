...
除非你指定了特定的开发分支或标记名，否则 Git 会克隆 "master "分支，从而产生 "master "的最新开发变更快照。关于如何签出特定的开发分支，或如何根据标签名签出本地分支，请分别参阅 "[在 Poky 中按分支签出](#2-4-2_在-Poky-中按分支签出)" 和 "[在 Poky 中按标签签出](#2-4-3_在-Poky-中按标签签出)" 章节。
...
如果你有本地 poky Git 仓库，请切换到该目录。如果本地没有 poky，请参阅 "[克隆 poky 仓库](#2-4-1_克隆-poky-仓库)" 部分。
...
## 3-8_使用-bitbake-layers-脚本创建常规图层
